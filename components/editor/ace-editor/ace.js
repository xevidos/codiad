...
}), define("ace/lib/dom", ["require", "exports", "module"], function (e, t, n)
{
	...
	t.buildDom = function s(e, t, n)
	{
		...
		{
			var t = f[e];
			e === "class" ? a.className = Array.isArray(t) ? t.join(" ") : t : typeof t == "function" || e == "value" ? a[e] = t : e === "ref" ? n && (n[t] = a) : t != null && a.setAttribute(e, t)
		}), t && t.appendChild(a), a
	...
	}, t.importCssString = function (n, r, i)
	{
		...
		u.appendChild(o.createTextNode(n)), r && (u.id = r), s == o && (s = t.getDocumentHead(o)), s.appendChild(u)
	...
	if (typeof document != "undefined")
	{
		...
		typeof i.style.animationName != "undefined" && (t.HAS_CSS_ANIMATION = !0)
	}
...
}), define("ace/lib/event", ["require", "exports", "module", "ace/lib/keys", "ace/lib/useragent"], function (e, t, n)
{
	...
	}, t.addTouchMoveListener = function (e, n)
	{
		...
		}), t.addListener(e, "touchmove", function (e)
		{
			...
			var s = t[0];
			e.wheelX = r - s.clientX, e.wheelY = i - s.clientY, r = s.clientX, i = s.clientY, n(e)
		})
...
}), define("ace/keyboard/textinput_ios", ["require", "exports", "module", "ace/lib/event", "ace/lib/useragent", "ace/lib/dom", "ace/lib/lang", "ace/lib/keys"], function (e, t, n)
{
	"use strict";
	var r = e("../lib/event"),
		i = e("../lib/useragent"),
	...
	t.TextInput = c
}), define("ace/keyboard/textinput", ["require", "exports", "module", "ace/lib/event", "ace/lib/useragent", "ace/lib/dom", "ace/lib/lang", "ace/keyboard/textinput_ios"], function (e, t, n)
{
	"use strict";
	var r = e("../lib/event"),
		i = e("../lib/useragent"),
		...
		c = function (e, t)
		{
			...
			{
				if (v) return;
				n.value = c, i.isWebKit && x.schedule()
			}
			...
			function U()
			{
				...
				{
					m && (n.style.cssText = m, m = ""), t.renderer.$keepTextAreaAtCursor == null && (t.renderer.$keepTextAreaAtCursor = !0, t.renderer.$moveTextAreaToCursor())
				}, 0)
			}
			...
			try
			{
				var w = document.activeElement === n
			}
			catch (E)
			{}
			...
			}), this.$focusScroll = !1, this.focus = function ()
			{
				...
				if (t)
				{
					...
					while (i && i.nodeType == 1) r.push(i), i.setAttribute("ace_nocontext", !0), !i.parentElement && i.getRootNode ? i = i.getRootNode().host : i = i.parentElement
				}
				n.focus(
				{
					preventScroll: !0
			...
			var S = o.delayedCall(function ()
				{
					w && T(g)
				}),
				x = o.delayedCall(function ()
				{
					v || (n.value = c, w && T())
				});
			i.isWebKit || t.addEventListener("changeSelection", function ()
			{
				t.selection.isEmpty() != g && (g = !g, S.schedule())
			}), N(), w && t.onFocus();
			var C = function (e)
				{
					return e.selectionStart === 0 && e.selectionEnd === e.value.length
				...
				k = function (e)
				{
					p ? p = !1 : C(n) ? (t.selectAll(), T()) : L && T(t.selection.isEmpty())
				},
				L = null;
			this.setInputHandler = function (e)
			{
			...
			var A = !1,
				O = function (e)
				{
					L && (e = L(e), L = null), d ? (T(), e && t.onPaste(e), d = !1) : e == c.charAt(0) ? A ? t.execCommand("del",
					{
						source: "ace"
					}) : t.execCommand("backspace",
					{
				...
				D = function (e, i)
				{
					var s = t.getCopyText();
					if (!s) return r.preventDefault(e);
					_(e, s) ? (i ? t.onCut() : t.onCopy(), r.preventDefault(e)) : (p = !0, n.value = s, n.select(), setTimeout(function ()
					{
						p = !1, N(), T(), i ? t.onCut() : t.onCopy()
					}))
				},
				P = function (e)
				{
				...
				{
					var s = _(e);
					typeof s == "string" ? (s && t.onPaste(s, e), i.isIE && setTimeout(T), r.preventDefault(e)) : (n.value = "", d = !0)
				};
			...
			var j = function (e)
				{
					...
					v = {}, v.canUndo = t.session.$undoManager, t.onCompositionStart(), setTimeout(F, 0), t.on("mousedown", I), v.canUndo && !t.selection.isEmpty() && (t.insert(""), t.session.markUndoGroup(), t.selection.clearSelection()), t.session.markUndoGroup()
				},
				F = function ()
				{
					if (!v || !t.onCompositionUpdate || t.$readOnly) return;
					var e = n.value.replace(h, "");
					if (v.lastValue === e) return;
					t.onCompositionUpdate(e), v.lastValue && t.undo(), v.canUndo && (v.lastValue = e);
					if (v.lastValue)
					{
						var r = t.selection.getRange();
						t.insert(v.lastValue), t.session.markUndoGroup(), v.range = t.selection.getRange(), t.selection.setRange(r), t.selection.clearSelection()
					}
				},
				I = function (e)
				{
					...
					L = function (n)
					{
						return s && clearTimeout(s), n = n.replace(h, ""), n == r.lastValue ? "" : (r.lastValue && s && t.undo(), n)
					}, t.onCompositionEnd(), t.removeListener("mousedown", I), e.type == "compositionend" && r.range && t.selection.setRange(r.range);
					var o = i.isIE || i.isChrome && i.isChrome >= 53 || i.isWebKit && i.isWebKit >= 603;
					o && M()
				},
				q = o.delayedCall(F, 50);
			...
			{
				q.schedule()
			}), r.addListener(n, "compositionend", I), this.getElement = function ()
			{
				return n
			...
			{
				A = !0, T(t.selection.isEmpty()), t._emit("nativecontextmenu",
				{
					target: t,
					domEvent: e
				}), this.moveToMouse(e, !0)
			...
			{
				m || (m = n.style.cssText), n.style.cssText = (o ? "z-index:100000;" : "") + "height:" + n.style.height + ";" + (i.isIE ? "opacity:0.1;" : "");
				...
				h(e);
				if (e.type != "mousedown") return;
				t.renderer.$keepTextAreaAtCursor && (t.renderer.$keepTextAreaAtCursor = null), clearTimeout(R), i.isWin && r.capture(t.container, h, U)
...
}), define("ace/mouse/default_handlers", ["require", "exports", "module", "ace/lib/dom", "ace/lib/event", "ace/lib/useragent"], function (e, t, n)
{
	...
	(function ()
	{
		...
		{
			var e = f(this.mousedownEvent.x, this.mousedownEvent.y, this.x, this.y),
				t = Date.now();
		...
		}, this.onMouseWheel = function (e)
		{
			...
			var n = this.$lastScroll,
				...
				s = i ? e.wheelX / i : n.vx,
				o = i ? e.wheelY / i : n.vy;
			i < u && (s = (s + n.vx) / 2, o = (o + n.vy) / 2);
			var a = Math.abs(s / o),
				f = !1;
			a >= 1 && t.renderer.isScrollableBy(e.wheelX * e.speed, 0) && (f = !0), a <= 1 && t.renderer.isScrollableBy(0, e.wheelY * e.speed) && (f = !0);
			if (f) n.allowed = r;
			else if (r - n.allowed < u)
			{
				var l = Math.abs(s) <= 1.1 * Math.abs(n.vx) && Math.abs(o) <= 1.1 * Math.abs(n.vy);
...
}), define("ace/mouse/dragdrop_handler", ["require", "exports", "module", "ace/lib/dom", "ace/lib/event", "ace/lib/useragent"], function (e, t, n)
{
	...
	function f(e)
	{
		...
		function L()
		{
			clearInterval(v), t.session.removeMarker(h), h = null, t.selection.fromOrientedRange(m), t.isFocused() && !w && t.renderer.$cursorLayer.setBlinking(!t.getReadOnly()), m = null, g = null, y = 0, E = null, S = null, i.removeListener(document, "mousemove", O)
		}
	...
	(function ()
	{
		...
		}, this.captureMouse = function (e, t)
		{
			...
			var o = this,
				...
				f = function (e)
				{
					n.off("beforeEndOperation", c), clearInterval(h), l(), o[o.state + "End"] && o[o.state + "End"](e), o.state = "", s.$keepTextAreaAtCursor == null && (s.$keepTextAreaAtCursor = !0, s.$moveTextAreaToCursor()), o.isMousePressed = !1, o.$onCaptureMouseMove = o.releaseMouse = null, e && o.onMouseEvent("mouseup", e)
				},
				l = function ()
				{
			...
			n.on("beforeEndOperation", c), o.$onCaptureMouseMove = a, o.releaseMouse = r.capture(this.editor.container, a, f);
...
}), define("ace/mouse/fold_handler", ["require", "exports", "module", "ace/lib/dom"], function (e, t, n)
{
	"use strict";
...
}), define("ace/lib/bidiutil", ["require", "exports", "module"], function (e, t, n)
{
	"use strict";
	...
	t.L = g, t.R = y, t.EN = b, t.ON_R = 3, t.AN = 4, t.R_H = 5, t.B = 6, t.DOT = "·", t.doBidiReorder = function (e, n, r)
	{
	...
	{
		var n = !1;
		for (var r = 0; r < e.length; r++) t[r] = R(e.charAt(r)), !n && (t[r] == y || t[r] == T) && (n = !0);
		return n
...
}), define("ace/bidihandler", ["require", "exports", "module", "ace/lib/bidiutil", "ace/lib/lang", "ace/lib/useragent"], function (e, t, n)
{
	"use strict";
	var r = e("./lib/bidiutil"),
		...
		u = function (e)
		{
			this.session = e, this.bidiMap = {}, this.currentRow = null, this.bidiUtil = r, this.charWidths = [], this.EOL = "¬", this.showInvisibles = !0, this.isRtlDir = !1, this.line = "", this.wrapIndent = 0, this.isLastRow = !1, this.EOF = "¶", this.seenBidi = !1
		};
	(function ()
	{
		...
		{
			this.seenBidi ? this.currentRow = null : e.action == "insert" && o.test(e.lines.join("\n")) && (this.seenBidi = !0, this.currentRow = null)
		...
		{
			e === undefined && (e = this.getDocumentRow()), this.wrapIndent = 0, this.isLastRow = e === this.session.getLength() - 1, this.line = this.session.getLine(e);
			if (this.session.$useWrapMode)
			{
				var n = this.session.$wrapData[e];
				n && (t === undefined && (t = this.getSplitIndex()), t > 0 && n.length ? (this.wrapIndent = n.indent, this.line = t < n.length ? this.line.substring(n[t - 1], n[n.length - 1]) : this.line.substring(n[n.length - 1])) : this.line = this.line.substring(0, n[t]))
			}
			var s = this.session,
				o = 0,
				u;
			...
			{
				return e === "	" || s.isFullWidth(e.charCodeAt(0)) ? (u = e === "	" ? s.getScreenTabSize(t + o) : 2, o += u - 1, i.stringRepeat(r.DOT, u)) : e
			})
		...
		}, this.updateCharacterWidths = function (e)
		{
			...
			this.charWidths[r.L] = this.charWidths[r.EN] = this.charWidths[r.ON_R] = t, this.charWidths[r.R] = this.charWidths[r.AN] = n, this.charWidths[r.R_H] = s.isChrome ? n : n * .45, this.charWidths[r.B] = 0, this.currentRow = null
		...
		}, this.getPosLeft = function (e)
		{
			...
			var t = r.getVisualFromLogicalIdx(e > 0 ? e - 1 : 0, this.bidiMap),
				...
				i = 0;
			e === 0 && n[t] % 2 !== 0 && t++;
			for (var s = 0; s < t; s++) i += this.charWidths[n[s]];
			return e !== 0 && n[t] % 2 === 0 && (i += this.charWidths[n[t]]), this.wrapIndent && (i += this.wrapIndent * this.charWidths[r.L]), i
		}, this.getSelections = function (e, t)
		{
			var n = this.bidiMap,
				i = n.bidiLevels,
				s, o = this.wrapIndent * this.charWidths[r.L],
				u = [],
				a = Math.min(e, t) - this.wrapIndent,
				f = Math.max(e, t) - this.wrapIndent,
				l = !1,
				c = !1,
				h = 0;
			for (var p, d = 0; d < i.length; d++) p = n.logicalFromVisual[d], s = i[d], l = p >= a && p < f, l && !c ? h = o : !l && c && u.push(
			{
				left: h,
				width: o - h
			}), o += this.charWidths[s], c = l;
		...
		}, this.offsetToCol = function (e)
		{
			...
			this.wrapIndent && (e -= this.wrapIndent * this.charWidths[r.L]);
			while (e > n + o / 2)
			{
				n += o;
				if (i === s.length - 1)
...
}), define("ace/selection", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/lib/event_emitter", "ace/range"], function (e, t, n)
{
	...
	(function ()
	{
		...
		}, this.moveCursorBy = function (e, t)
		{
			...
			var i = this.session.screenToDocumentPosition(n.row + e, n.column, r);
...
}), define("ace/token_iterator", ["require", "exports", "module", "ace/range"], function (e, t, n)
{
	"use strict";
	var r = e("./range").Range,
		i = function (e, t, n)
...
}), define("ace/mode/text", ["require", "exports", "module", "ace/tokenizer", "ace/mode/text_highlight_rules", "ace/mode/behaviour/cstyle", "ace/unicode", "ace/lib/lang", "ace/token_iterator", "ace/range"], function (e, t, n)
{
	...
	(function ()
	{
		this.$defaultBehaviour = new s, this.tokenRe = new RegExp("^[" + o.wordChars + "\\$_]+", "g"), this.nonTokenRe = new RegExp("^(?:[^" + o.wordChars + "\\$_]|\\s])+", "g"), this.getTokenizer = function ()
		{
		...
		}, this.$onChange = function (e)
		{
			...
			if (e.action == "insert")
			{
				...
				for (; o < u; o++)
				{
					...
					a.start.row == r && a.start.column >= t.column && (a.start.column != t.column || !this.$insertRight) && (a.start.column += l, a.start.row += f);
			...
			else
			{
				...
				for (; o < u; o++)
				{
					...
					a.end.row < i && (a.end.row = r, a.end.column = t.column);
					if (a.start.row < i || a.start.row == i && a.start.column <= n.colum) a.start.row = r, a.start.column = t.column;
					if (a.end.row == i)
...
}), define("ace/edit_session/bracket_match", ["require", "exports", "module", "ace/token_iterator", "ace/range"], function (e, t, n)
{
	...
	var r = e("../token_iterator").TokenIterator,
		i = e("../range").Range;
	t.BracketMatch = s
}), define("ace/edit_session", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/bidihandler", "ace/config", "ace/lib/event_emitter", "ace/selection", "ace/mode/text", "ace/range", "ace/document", "ace/background_tokenizer", "ace/search_highlight", "ace/edit_session/folding", "ace/edit_session/bracket_match"], function (e, t, n)
{
	"use strict";
	var r = e("./lib/oop"),
		i = e("./lib/lang"),
		...
		d = function (e, t)
		{
			...
			this.$bidiHandler = new s(this), this.setDocument(e), this.selection = new a(this), o.resetOptions(this), this.setMode(t), o._signal("session", this)
		};
	d.$uid = 0,
		function ()
		{
			...
			}, this.$getUndoSelection = function (e, t)
			{
				...
				for (var o = 0; o < e.length; o++)
				{
					...
					if (!r)
					{
						n(u) ? (r = l.fromPoints(u.start, u.end), s = !0) : (r = l.fromPoints(u.start, u.start), s = !1);
						continue
					}
			...
			this.$computeWrapSplits = function (e, r, i)
			{
				...
				function y(t)
				{
					...
					{
						r -= 1
					}), o.length || (b = g(), o.indent = b), l += r, o.push(l), f = t
				}
...
}), define("ace/commands/default_commands", ["require", "exports", "module", "ace/lib/lang", "ace/config", "ace/range"], function (e, t, n)
{
	...
	},
	{
		...
		exec: function (e, t)
		{
			typeof t != "number" && (t = parseInt(prompt("Enter line number:"), 10)), isNaN(t) || e.gotoLine(t)
		},
		readOnly: !0
	},
	{
...
}), define("ace/editor", ["require", "exports", "module", "ace/lib/fixoldbrowsers", "ace/lib/oop", "ace/lib/dom", "ace/lib/lang", "ace/lib/useragent", "ace/keyboard/textinput", "ace/mouse/mouse_handler", "ace/mouse/fold_handler", "ace/keyboard/keybinding", "ace/edit_session", "ace/search", "ace/range", "ace/lib/event_emitter", "ace/commands/command_manager", "ace/commands/default_commands", "ace/config", "ace/token_iterator", "ace/clipboard"], function (e, t, n)
{
	...
	w.$uid = 0,
		function ()
		{
			...
			{
				this.commands.on("exec", this.startOperation.bind(this), !0), this.commands.on("afterExec", this.endOperation.bind(this), !0), this.$opResetTimer = s.delayedCall(this.endOperation.bind(this)), this.on("change", function ()
				{
...
}), define("ace/undomanager", ["require", "exports", "module", "ace/range"], function (e, t, n)
{
	...
	(function ()
	{
		...
		}, this.undo = function (e, t)
		{
			...
			var r = n.pop(),
				s = null;
			return r && r.length && (s = e.undoChanges(r, t), this.$redoStack.push(r), this.$syncRev()), this.$fromUndo = !1, s
	...
	(function ()
	{
			...
			for (var n in this.markers)
			{
				...
				if (r.renderer)
				{
					var s = this.$getTop(i.start.row, e),
						o = this.$padding + (this.session.$bidiHandler.isBidiRow(i.start.row) ? this.session.$bidiHandler.getPosLeft(i.start.column) : i.start.column * e.characterWidth);
		...
		}, this.drawTextMarker = function (t, n, i, s, o)
		{
			var u = this.session,
				...
				d = null,
				v = new r(l, n.start.column, l, h);
			for (; l <= f; l++) v.start.row = v.end.row = l, v.start.column = l == a ? n.start.column : u.getRowWrapIndent(l), v.end.column = p, c = h, h = p, p = l + 1 < f ? u.getScreenLastRowColumn(l + 1) : l == f ? 0 : n.end.column, d = i + (l == a ? " ace_start" : "") + " ace_br" + e(l == a || l == a + 1 && n.start.column, c < h, h > p, l == f), this.session.$bidiHandler.isBidiRow(l) ? this.drawBidiSingleLineMarker(t, v, d, s, l == f ? 0 : 1, o) : this.drawSingleLineMarker(t, v, d, s, l == f ? 0 : 1, o)
		}, this.drawMultiLineMarker = function (e, t, n, r, i)
		{
			...
			else o = r.lineHeight, u = this.$getTop(t.start.row, r), a = s + t.start.column * r.characterWidth, e.push("<div class='", n, " ace_br1 ace_start' style='", "height:", o, "px;", "right:0;", "top:", u, "px;", "left:", a, "px;", i, "'></div>");
			...
			else
			{
				...
				o = r.lineHeight, u = this.$getTop(t.end.row, r), e.push("<div class='", n, " ace_br12' style='", "height:", o, "px;", "width:", l, "px;", "top:", u, "px;", "left:", s, "px;", i, "'></div>")
			}
	...
	(function ()
	{
		this.schedule = function (e)
		{
			...
			if (this.changes)
			{
				...
				{
					var n = t.changes;
					n && (r.blockIdle(100), t.changes = 0, t.onRender(n)), t.changes && t.schedule()
				})
			}
		}
	}).call(i.prototype), t.RenderLoop = i
}), define("ace/layer/font_metrics", ["require", "exports", "module", "ace/lib/oop", "ace/lib/dom", "ace/lib/lang", "ace/lib/event", "ace/lib/useragent", "ace/lib/event_emitter"], function (e, t, n)
{
	var r = e("../lib/oop"),
		i = e("../lib/dom"),
		s = e("../lib/lang"),
		...
		{
			this.el = i.createElement("div"), this.$setMeasureNodeStyles(this.el.style, !0), this.$main = i.createElement("div"), this.$setMeasureNodeStyles(this.$main.style), this.$measureNode = i.createElement("div"), this.$setMeasureNodeStyles(this.$measureNode.style), this.el.appendChild(this.$main), this.el.appendChild(this.$measureNode), e.appendChild(this.el), this.$measureNode.innerHTML = s.stringRepeat("X", f), this.$characterSize = {
				width: 0,
				height: 0
	...
	(function ()
	{
		...
		}, this.$moveTextAreaToCursor = function ()
		{
			...
			var t = this.layerConfig,
				n = this.$cursorLayer.$pixelPos.top,
				r = this.$cursorLayer.$pixelPos.left;
			n -= t.offset;
			...
			r -= this.scrollLeft, r > this.$size.scrollerWidth - s && (r = this.$size.scrollerWidth - s), r += this.gutterWidth, e.height = i + "px", e.width = s + "px", e.left = Math.min(r, this.$size.scrollerWidth - s) + "px", e.top = Math.min(n, this.$size.height - i) + "px"
		}, this.getFirstVisibleRow = function ()
		{
		...
		}, this.screenToTextCoordinates = function (e, t)
		{
			...
			var i = e + this.scrollLeft - n.left - this.$padding,
				...
				u = (t + this.scrollTop - n.top) / this.lineHeight;
		...
		}, this.setTheme = function (e, t)
		{
			function o(r)
			{
				...
				var s = "padding" in r ? r.padding : "padding" in (n.theme ||
				{}) ? 4 : n.$padding;
...
}), define("ace/worker/worker_client", ["require", "exports", "module", "ace/lib/oop", "ace/lib/net", "ace/lib/event_emitter", "ace/config"], function (e, t, n)
{
	...
	(function ()
	{
		...
		}, this.terminate = function ()
		{
			...
			{}), this.deltaQueue = null, this.$worker.terminate(), this.$worker = null, this.$doc && this.$doc.off("change", this.changeListener), this.$doc = null
...
}), define("ace/mouse/multi_select_handler", ["require", "exports", "module", "ace/lib/event", "ace/lib/useragent"], function (e, t, n)
{
	...
	function o(e)
	{
		...
		else if (S == "block")
		{
			...
			var L = function (e)
				{
					clearInterval(O), l.removeSelectionMarkers(C), C.length || (C = [c.toOrientedRange()]), N && (l.removeSelectionMarker(N), c.toSingleRange(N));
...
}), define("ace/multi_select", ["require", "exports", "module", "ace/range_list", "ace/range", "ace/selection", "ace/mouse/multi_select_handler", "ace/lib/event", "ace/lib/lang", "ace/commands/multi_select_commands", "ace/search", "ace/edit_session", "ace/editor", "ace/config"], function (e, t, n)
{
	...
	(function ()
	{
		...
		}, this.$onMultiSelectExec = function (e)
		{
			...
			else t.multiSelectAction == "forEach" ? r = n.forEachSelection(t, e.args) : t.multiSelectAction == "forEachLine" ? r = n.forEachSelection(t, e.args, !0) : t.multiSelectAction == "single" ? (n.exitMultiSelectMode(), r = t.exec(n, e.args ||
		...
		}, this.forEachSelection = function (e, t, n)
		{
			...
			var r = n && n.keepOrder,
				...
				f = (r ? u : a).ranges,
				l;
			if (!f.length) return e.exec ? e.exec(this, t ||
			{}) : e(this, t ||
			{});
...
}), define("ace/ace", ["require", "exports", "module", "ace/lib/fixoldbrowsers", "ace/lib/dom", "ace/lib/event", "ace/range", "ace/editor", "ace/edit_session", "ace/undomanager", "ace/virtual_renderer", "ace/worker/worker_client", "ace/keyboard/hash_handler", "ace/placeholder", "ace/multi_select", "ace/mode/folding/fold_mode", "ace/theme/textmate", "ace/ext/error_marker", "ace/config"], function (e, t, n)
{
	...
	}, t.Range = s, t.EditSession = u, t.UndoManager = a, t.VirtualRenderer = f, t.version = "1.3.3"
});
(function ()
{
